...
const I18N = {
    ar: {
        ...
        install_app: 'تثبيت التطبيق', install_app_sub: 'أضف التطبيق إلى جهازك لوصول أسرع',
        ...
        my_orders_sub: 'تصفّح كل طلبات الاشتراك السابقة وحالتها',
        general_settings: 'الإعدادات العامة', dark_mode: 'المظهر الداكن', dark_mode_sub: 'الوضع الليلي للتطبيق',
        plan_unavailable_msg: 'الباقة التي اخترتها لم تعد متاحة، الرجاء اختيار باقة أخرى.',
        amount_label: 'المبلغ',
        order_details: 'تفاصيل الطلب', order_date: 'تاريخ الطلب', order_type: 'نوع الطلب',
        renewal_order: 'تجديد استضافة', admin_note: 'ملاحظة الإدارة',
        order_status_completed: 'دفع مكتمل ✅', order_status_in_progress: 'قيد التقدم ⏳', order_status_cancelled: 'ملغي ❌',
        auto_renew: 'التجديد التلقائي', auto_renew_sub: 'تجديد استضافاتك تلقائياً من رصيدك عند الانتهاء',
        onboarding_welcome_title: 'أهلاً بك 👋', onboarding_welcome_sub: 'خطوتان سريعتان لإعداد حسابك',
        onboarding_continue: 'متابعة', onboarding_currency_hint: 'يمكنك تغييرها لاحقاً من الإعدادات',
        renewal_pending_msg: 'طلب التجديد قيد المراجعة من الإدارة',
    },
    en: {
        ...
        install_app: 'Install App', install_app_sub: 'Add the app to your device for faster access',
        ...
        my_orders_sub: 'Browse all your past subscription orders and their status',
        general_settings: 'General Settings', dark_mode: 'Dark Mode', dark_mode_sub: 'Night mode for the app',
        plan_unavailable_msg: 'The plan you selected is no longer available. Please choose another plan.',
        amount_label: 'Amount',
        order_details: 'Order Details', order_date: 'Order Date', order_type: 'Order Type',
        renewal_order: 'Hosting Renewal', admin_note: 'Admin Note',
        order_status_completed: 'Payment Completed ✅', order_status_in_progress: 'In Progress ⏳', order_status_cancelled: 'Cancelled ❌',
        auto_renew: 'Auto-Renewal', auto_renew_sub: 'Automatically renew your hosting from your balance when it expires',
        onboarding_welcome_title: 'Welcome 👋', onboarding_welcome_sub: 'Two quick steps to set up your account',
        onboarding_continue: 'Continue', onboarding_currency_hint: 'You can change this later in Settings',
        renewal_pending_msg: 'Renewal request pending admin review',
    },
};
