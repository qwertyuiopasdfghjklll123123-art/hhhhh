...
CREATE TABLE IF NOT EXISTS categories (
    ...
    image_data MEDIUMBLOB NULL DEFAULT NULL,
    image_mime VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS companies (
    ...
    logo_data MEDIUMBLOB NULL DEFAULT NULL,
    logo_mime VARCHAR(100) NULL DEFAULT NULL,
    deleted_card ENUM('no','ok') NOT NULL DEFAULT 'no',
    sort_order INT NOT NULL DEFAULT 0,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS products (
    ...
    img_data MEDIUMBLOB NULL DEFAULT NULL,
    img_mime VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS settings (
    ...
    app_logo_data MEDIUMBLOB NULL DEFAULT NULL,
    app_logo_mime VARCHAR(100) NULL DEFAULT NULL,
